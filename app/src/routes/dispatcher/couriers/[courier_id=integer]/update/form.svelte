<script lang="ts">
	...
	export let courier: CourierType;
	...
	$formData.email = courier.email;
	$formData.fname = courier.fname;
	$formData.lname = courier.lname;
	$formData.phone = courier.phone;
	$formData.addr_street = courier.addr_street;
	$formData.addr_number = courier.addr_number;
	$formData.addr_city = courier.addr_city;
	$formData.addr_country = courier.addr_country;
	$formData.addr_zip = courier.addr_zip;
	$formData.password = '';
</script>
...
<form method="POST" use:enhance>
	...
	<div class="my-2 flex w-full justify-center">
		<Form.Button>Ažuriraj kurira</Form.Button>
	</div>
</form>
